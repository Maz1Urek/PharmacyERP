"""Views for the Pharmacy Management System.

This module contains view functions for:
- Admin dashboard and management pages
- Pharmacist dashboard, cart, and order handling
- Reporting and invoice generation

Most views are protected with @login_required to ensure that only authenticated
