"""Database models for the Pharmacy Management System.

Each model represents a real-world entity in the pharmacy:
- Company: pharmaceutical companies supplying medicines
- Medicine: individual medicines with price and quantity details
- Pharmacist: staff members who create orders
- Cart, Order, History: models used to manage and track transactions"""
...
# NOTE: The above models are used throughout the project via Django's ORM.
# When migrations are applied, these classes are converted into actual database tables.
